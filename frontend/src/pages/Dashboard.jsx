  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">{t('dashboard_title')}</h1>
        <p className="text-xs sm:text-sm text-gray-500 mt-1">Regional Distress Monitoring & Farmer Support</p>
      </div>
