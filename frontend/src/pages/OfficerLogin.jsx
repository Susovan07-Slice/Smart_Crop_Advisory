...
import { User, Lock, Phone, KeyRound, ArrowRight, Loader2, History, X, CheckCircle2, RotateCw, ShieldCheck } from 'lucide-react';
...
const OfficerLogin = () => {
  ...
  const [recentPhones, setRecentPhones] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem('recentOfficerPhones')) || [];
    } catch {
      return [];
    }
  });
  ...
  const [recentUsernames, setRecentUsernames] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem('recentOfficerUsernames')) || [];
    } catch {
      return [];
    }
  });
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-sm sm:max-w-md w-full space-y-5 sm:space-y-6 bg-white/95 backdrop-blur-sm p-5 sm:p-8 rounded-2xl shadow-xl border border-blue-100">
        
        {/* Header */}
        <div className="text-center">
          <div className="inline-flex items-center justify-center p-2.5 bg-blue-100 text-blue-800 rounded-2xl mb-2">
            ...
            <form className="space-y-4" onSubmit={handleRequestOtp}>
              <div className="relative rounded-xl shadow-xs">
                ...
                <input
                  ...
                  required
                  autoComplete="off"
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 text-base sm:text-lg border-gray-300 rounded-xl py-3 sm:py-3.5 bg-gray-50 border font-mono tracking-wider"
            ...
            <form className="space-y-4" onSubmit={handleVerifyOtp}>
              <div className="relative rounded-xl shadow-xs">
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 text-base sm:text-lg border-gray-300 rounded-xl py-3 sm:py-3.5 bg-gray-50 border text-center tracking-widest font-bold font-mono"
                  placeholder="••••••"
                  value={otp}
            ...
            <div className="space-y-3">
              <div className="relative rounded-xl shadow-xs">
                ...
                <input
                  ...
                  required
                  autoComplete="off"
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 text-base sm:text-lg border-gray-300 rounded-xl py-3 sm:py-3.5 bg-gray-50 border"
