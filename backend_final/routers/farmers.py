...
def get_dashboard_data(district: Optional[str] = None, db: Session = Depends(database.get_db)):
    ...
    for f in farmers:
        ...
        distress_res = calculate_comprehensive_distress_score(
            loan_amount=float(f.loan_amount or 0.0),
            outstanding_principal=float(f.loan_amount or 0.0) * 0.75,
            days_to_loan_due=int(f.days_to_loan_due or 60),
        ...
        farmer_data = {
            ...
            "loan_amount": f.loan_amount or 0.0,
